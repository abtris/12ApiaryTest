...
This repository describes the 12ApiaryTest API. The description from the master branch is automatically rendered into [API Documentation](http://docs.12apiarytest.apiary.dev).
...
If you want to develop a client for this API, head [to the documentation](http://docs.12apiarytest.apiary.dev) to get the address of the mock server (lives on `apiary-mock.com`) generated from this blueprint.
